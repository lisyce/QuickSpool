...
function LoadingThreadCard({ headingWidth }) {
  ...
  return <>
    <a href='#' tabIndex={-1} className='disabled placeholder-glow list-group-item list-group-item-action d-flex justify-content-between'>
      <span className='placeholder threadcard-header threadcard-header-responsive my-auto placeholder-threadname' style={{width: headingWidth}}></span>
